...
class ChickenGauge {
    ...
    constructor() {
        ...
        this._emptyImage.srcRect.set(ControlSize.cs.chickenGaugeEmpty.x, ControlSize.cs.chickenGaugeEmpty.y, ControlSize.cs.chickenGaugeEmpty.width, ControlSize.cs.chickenGaugeEmpty.height);
        ...
        this._fullImage.srcRect.set(ControlSize.cs.chickenGaugeFull.x, ControlSize.cs.chickenGaugeFull.y, ControlSize.cs.chickenGaugeFull.width, ControlSize.cs.chickenGaugeFull.height);
