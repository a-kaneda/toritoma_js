...
class ChickenGauge {
    ...
    constructor() {
        ...
        // 空ゲージの画像を読み込む。
        this._emptyImage = new phina.display.Sprite('control', ControlSize.chickenGaugeEmpty.width, ControlSize.chickenGaugeEmpty.height);
        this._emptyImage.srcRect.set(ControlSize.chickenGaugeEmpty.x, ControlSize.chickenGaugeEmpty.y, ControlSize.chickenGaugeEmpty.width, ControlSize.chickenGaugeEmpty.height);
        ...
        // 満ゲージの画像を読み込む。
        this._fullImage = new phina.display.Sprite('control', ControlSize.chickenGaugeFull.width, ControlSize.chickenGaugeFull.height);
        this._fullImage.srcRect.set(ControlSize.chickenGaugeFull.x, ControlSize.chickenGaugeFull.y, ControlSize.chickenGaugeFull.width, ControlSize.chickenGaugeFull.height);
