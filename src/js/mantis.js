    ...
    action(scene) {
            ...
            case SHOT_STATE.ARC_SHOT:// 弧形弾発射
                ...
                if (this._upArmNum === 0) {
                    ...
                    if (this._shotInterval[0] > ARC_SHOT_INTERVAL) {
                        ...
                        this._shotInterval[0] = 0;
                        // 弧形弾を発射する。
                        EnemyShot.fireGroupShot(this._hitArea, ARC_SHOT_POSITION, ARC_SHOT_COUNT, ARC_SHOT_SPEED, scene);
                    }
                }
                break;
            case SHOT_STATE.BURST_SHOT:// 破裂弾発射
                ...
                if (this._upArmNum === 0) {
                    ...
                    if (this._shotInterval[0] > BURST_SHOT_INTERVAL) {
                        ...
                        EnemyShot.fireBurstShot(position, BURST_SHOT_COUNT, BURST_SHOT_ANGLE_INTERVAL, BURST_SHOT_BEFORE_SPEED, BURST_SHOT_BURST_INTERVAL, BURST_SHOT_AFTER_SPEED, scene);
                    }
                }
                break;
            case SHOT_STATE.NWAY_SHOT:// n-way弾発射
                ...
                if (this._upArmNum === 0) {
                    ...
                    if (this._shotInterval[0] > NWAY_SHOT_INTERVAL) {
                        ...
                        EnemyShot.fireNWay(position, Util.calcAngle(this._hitArea, scene.playerPosition), NWAY_COUNT[1 - this._upArmNum], NWAY_ANGLE_INTERVAL, NWAY_SHOT_SPEED, false, scene);
                    }
                }
                break;
            default:
        ...
        if (this._shotState !== SHOT_STATE.NO_SHOT) {
            ...
            if (this._shotInterval[1] > CYCLE_SHOT_INTERVAL) {
                EnemyShot.fireNWay(this._hitArea, Util.calcAngle(this._hitArea, scene.playerPosition), CYCLE_SHOT_COUNT, CYCLE_SHOT_ANGLE, CYCLE_SHOT_SPEED, false, scene);
