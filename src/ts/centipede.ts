...
// 状態遷移間隔
const STATE_INTERVAL: number[] = [170, 900, 900, 900];
// 移動方向変更の境界線x方向最小値
 ...
 * 敵キャラ、ムカデ。
 */
class Centipede extends Enemy implements CentipedeIF{
    ...
    /** x軸移動方向。-1: 左, 1: 右 */
    private _moveDirectionX: number;
    /** y軸移動方向。-1: 上, 1: 下 */
    private _moveDirectionY: number;
    /** 5Way弾発射間隔 */
    private _5wayInterval: number;
    /** 1Way弾待機間隔 */
    private _1wayWaitInterval: number;
    /** 1Way弾発射間隔 */
    private _1wayShotInterval: number;
    /** 状態遷移間隔 */
    private _stateInverval: number;
