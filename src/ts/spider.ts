...
enum STATE {
    ...
    NWAY_SHOT,          // n-way弾発射
    NET_SHOT,           // 蜘蛛の巣弾発射
    MOVE_TO_CENTER,     // 中央へ移動
    SIEGE,              // 2-way弾による包囲弾発射
    COUNT               // 状態の種類の数
};
// 状態遷移間隔
const STATE_INTERVAL = [999, 900, 900, 90, 900];
// 移動位置
const MOVE_POSITION: Point[] = [
    {x: 152, y: 48},
    {x: 106, y: 96},
    {x: 106, y: 48},
    {x: 152, y: 96},
...
// 包囲弾内のグループ弾の位置
const GROUP_SHOT_POSITION: Point[] = [
